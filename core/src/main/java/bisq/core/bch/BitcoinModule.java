...
import bisq.core.bch.wallet.BsqCoinSelector;
import bisq.core.bch.wallet.BsqWalletService;
import bisq.core.bch.wallet.BtcWalletService;
import bisq.core.bch.wallet.NonBsqCoinSelector;
...
public class BitcoinModule extends AppModule {
    ...
    protected void configure() {
        ...
        bindConstant().annotatedWith(named(BtcOptionKeys.BCH_NODES)).to(environment.getRequiredProperty(BtcOptionKeys.BCH_NODES));
        ...
        bindConstant().annotatedWith(named(BtcOptionKeys.USE_TOR_FOR_BCH)).to(environment.getRequiredProperty(BtcOptionKeys.USE_TOR_FOR_BCH));
