...
package bisq.core.bch.wallet;

import bisq.core.bch.exceptions.InsufficientBsqException;
                        ...
                        if (txOptional.isPresent()) {
                            ...
                            if (daoStateService.isBsqTxOutputType(txOutput)) {
                                ...
                                if (txOutput.getValue() != connectedOutput.getValue().value)
                                    log.warn("getValueSentToMeForTransaction: Value of BSQ output do not match bitcoincashj tx output. " +
